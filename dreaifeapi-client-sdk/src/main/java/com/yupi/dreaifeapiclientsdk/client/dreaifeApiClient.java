package com.yupi.dreaifeapiclientsdk.client;
...
import static com.yupi.dreaifeapiclientsdk.utils.SignUtils.genSign;

public class dreaifeApiClient {

    private static final String GATEWAY_HOST = "http://127.0.0.1:8090";

    public dreaifeApiClient(String accessKey, String secretKey) {
